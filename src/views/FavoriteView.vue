...
<template>
  <div class="home-view-container">
    ...
    <div class="destination-container">
      <h3 v-if="!favoritePlace.length">
        Try adding favorite from <RouterLink to="/">here</RouterLink>
      </h3>
      <div
        class="destination"
        v-for="destination in favoritePlace"
        :key="destination.id"
      >
        <RouterLink to="/destination.slug">
          ...
          <button
            ...
            @click="(e) => removeFromFavorites(e, destination.id)"
          >
